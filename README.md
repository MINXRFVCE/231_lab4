...
<p align = "center">Итого мы получаем 50 программ, каждая из которых является решением соответсвующей задачи</p>

<h1 align = "center">Вывод</h1>
<p>По итогу проделанной лабораторной работы, я узнал о том, что такое HTML и как правильно работать с CSS, и использовал эти знания в решении задач.</p>
